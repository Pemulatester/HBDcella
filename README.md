...
<head>
    ...
    <title>Surat Spesial Buat Kamu cella �</title>
...
<body>
	...
	<div class="overlay">
	   ...
	   <div class="awalan">
	     ...
	     <label style="font-size:16px">cella is thebestttt</label>
    ...
    <div class="reset">
        ...
        <button id="open">Buka Suratnya Sayang��</button>
  ...
  <div class="container" id="container">
    ...
    <p class="titleC"><b>Alooo Kamuuu! Cella�</b></p>
  ...
  <div class="hidden">
      ...
      <p id="pesanSurat1"><i class='fontAlt'>Happy birthday dayy</i> sayangku cella</p>

      <p id="pesanSurat2">Akuu mauu bilangg sesuatuu buattt kamuu, makasiii udaaa hadirr di hidup akuuu, semenjak adaa kamuu hiduppp akuuu lebihh bewarnaaa dan lebih bahagiaa, <i>im very lucky to have you</i>, maaf ya sayanggg kalau aku belum bisa kasih yang terbaik buat kamuu, tapi aku sayanggg banget sama kamuuu cella�<br><br>Semoga kamu selalu diberikan umur yang panjang, sehat, dan penuh keberkahan. Aku harap setiap langkahmu selalu dimudahkan, impian-impianmu tercapai, dan kebahagiaan selalu menyertaimu. Tetaplah jadi sosok yang baik dan ceria seperti yang aku kenal. Aku selalu di sini buat kamu. � <b>i loveee youuuu</b> semestaakuuuu cella</p>

      <p id="pesanSurat3">Sekali lagi<br><i class='fontAlt'>Happy Birthday</i> yaa sayangku</p>
